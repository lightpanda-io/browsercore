...
pub const Node = struct {
    ...
    pub const _DOCUMENT_POSITION_DISCONNECTED = 1;
    pub const _DOCUMENT_POSITION_PRECEDING = 2;
    pub const _DOCUMENT_POSITION_FOLLOWING = 4;
    pub const _DOCUMENT_POSITION_CONTAINS = 8;
    pub const _DOCUMENT_POSITION_CONTAINED_BY = 16;
    pub const _DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC = 32;
